...
export default function NewProjectModal({ isOpen, onClose, divisions = [] }) {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            if (status === 422 && data?.errors) {
                ...
                setServerError(data?.message || 'Failed to create project. Please try again.');
            }
        } finally {
            setSubmitting(false);
        }
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={{ display: 'flex', gap: '12px', marginBottom: '16px' }}>
                        <div style={{ flex: 1 }}>
                            ...
                            {errors?.divisionId && (
                                <div style={errorTextStyle}>{errors.divisionId}</div>
                            )}
                        </div>
                        <div style={{ flex: 1 }}>
                            ...
                            {errors?.fundingType && (
                                <div style={errorTextStyle}>{errors.fundingType}</div>
                            )}
                        </div>
                    </div>
